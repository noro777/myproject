              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $book->text }}</td>
                    <td class="w-25">
                        <a href="{{ route('download',['filename'=>$book->file]) }}">girqy</a>
                    </td>
                    <td>{{ $book->author_id }}</td>
                    <td><a href="{{ route('admin.book.update',['id'=>$book->id]) }}">update</a></td>
                    <td><a href="{{ route('admin.book.delete',['id'=>$book->id]) }}">delete</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
