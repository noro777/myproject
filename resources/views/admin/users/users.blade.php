...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('admin.user.register') }}" class="btn btn-primary">cteate</a>
    </div>
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $user->name }}</td>
                    <td>{{ $user->email }}</td>
                    <td><a href="{{ route('admin.user.update',['id'=>$user->id]) }}">update</a></td>
                    <td><a href="{{ route('admin.user.delete',['id'=>$user->id]) }}">delete</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
