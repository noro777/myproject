...
<div class="containrrrr">
    <div>
        ...
        <a href="{{ route('admin.author.create') }}" class="btn btn-primary">cteate</a>
    </div>
              ...
              <table class="table table-image">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ route('admin.author.update',['id'=>$author->id]) }}">update</a></td>
                    <td><a href="{{ route('admin.author.delete',['id'=>$author->id]) }}">delete</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
